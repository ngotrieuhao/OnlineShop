...
using OnlineShop.Application.Catalog.Categories;
using OnlineShop.Application.Catalog.Coupons;
using OnlineShop.Application.Catalog.Orders;
using OnlineShop.Application.Common;
using OnlineShop.Application.System.Languages;
using OnlineShop.Application.System.Roles;
...
namespace OnlineShop.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger VNtravel", Version = "v1" });
