    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Edit(UserUpdateRequest request)
        {
            ...
            if (result.IsSuccessed)
            {
                ...
                TempData["UpdateAccountSuccess"] = "Update customer information successfully";
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.IsSuccessed)
            {
                ...
                TempData["ChangePasswordSuccess"] = "Update password successfully";
                return View("Index", orders);
            }
        ...
        public async Task<IActionResult> CancelOrderStatus(int orderId)
        {
            ...
            if (result)
            {
                TempData["CancelOrderSuccess"] = "Cancel order successfully";
                return RedirectToAction("Index", "Account");
            }

            //ModelState.AddModelError("", "Huỷ đơn hàng thành công");
            TempData["CancelOrderFail"] = "Cancel order unsuccessfully";
            return RedirectToAction("Index", "Account");
        }
    }
}