...
namespace OnlineShop.AdminApp.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public async Task<IActionResult> Create([FromForm] ProductCreateRequest request)
        {
            ...
            if (result)
            {
                TempData["CreateProductSuccessful"] = "Add Product Successfully";
        ...
        public async Task<IActionResult> Edit([FromForm] ProductUpdateRequest request)
        {
            ...
            if (result)
            {
                TempData["UpdateProductSuccessful"] = "Update Product Successfully";
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> Delete(ProductDeleteRequest request)
        {
            ...
            if (result)
            {
                TempData["DeleteProductSuccessful"] = "Delete Product Successfully";
                return RedirectToAction("Index");
            }
