...
namespace OnlineShop.AdminApp.Controllers
{
    public class CouponController : BaseController
    {
        ...
        public async Task<IActionResult> Create([FromForm] CouponCreateRequest request)
        {
            ...
            if (result)
            {
                TempData["CreateCouponSuccessful"] = "Add Coupon Successfully";
                return RedirectToAction("Index");
            }

            ModelState.AddModelError("", "Add Coupon Failed");
            return View(request);
        }
        ...
        public async Task<IActionResult> Edit([FromForm] CouponUpdateRequest request)
        {
            ...
            if (result)
            {
                TempData["UpdateCouponSuccessful"] = "Update Coupon Successfully";
                return RedirectToAction("Index");
            }

            ModelState.AddModelError("", "Update Coupon Failed");
            return View(request);
        }
        ...
        public async Task<IActionResult> Delete(CouponDeleteRequest request)
        {
            ...
            if (result)
            {
                TempData["DeleteCouponSuccessful"] = "Delete Coupon Successful";
                return RedirectToAction("Index");
            }

            ModelState.AddModelError("", "Delete Coupon Failed");
            return View(request);
        }
