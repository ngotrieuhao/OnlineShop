...
namespace OnlineShop.AdminApp.Controllers
{
    public class OrderController : BaseController
    {
        ...
        public async Task<IActionResult> UpdateOrderStatus(int orderId)
        {
            ...
            if (result)
            {
                TempData["result"] = "Order Status Update Successfully";
                return RedirectToAction("Index");
            }

            TempData["resultFail"] = "Order Status Update Failed";
        ...
        public async Task<IActionResult> CancelOrderStatus(int orderId)
        {
            ...
            if (result)
            {
                TempData["CancelOrderSuccessful"] = "Cancel Order Successfully";
                return RedirectToAction("Index", "Order");
            }

            //ModelState.AddModelError("", "Huỷ đơn hàng thành công");
            TempData["resultFail"] = "Cancel Order Failed";
            return RedirectToAction("Index", "Order");
        }
    }
}