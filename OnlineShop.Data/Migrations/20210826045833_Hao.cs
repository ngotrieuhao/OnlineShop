    ...
    public partial class Hao : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is home page of OnlineShop" },
                    { "HomeKeyword", "This is keyword of OnlineShop" },
                    { "HomeDescription", "This is description of OnlineShop" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "206a1f34-c824-448f-80b6-5407211a3a2f", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "315/12 Tùng Thiện Vương", "0ee605a1-5509-4645-9ead-188096c84505", "ngotrieuhao@gmail.com", true, false, null, "Ngo Hao", "ngotrieuhao@gmail.com", "admin", "AQAAAAEAACcQAAAAEE1+yqhkQ7Qa4Y9uSr+S4Cv+eMr1yrpEgdi54M+bIQ4FbwjwY5Oid0ru0cbQeRjsEg==", "0944334052", false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "DateCreated", "Description", "Details", "Name", "Price", "ProductImage", "Stock", "Thumbnail" },
                values: new object[] { 1, 1, new DateTime(2021, 8, 26, 11, 58, 32, 124, DateTimeKind.Local).AddTicks(5106), "", "", "Adidas ULTRABOOST 21", 250m, null, 15, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "DateCreated", "Description", "Details", "Name", "Price", "ProductImage", "Stock", "Thumbnail" },
                values: new object[] { 2, 2, new DateTime(2021, 8, 26, 11, 58, 32, 128, DateTimeKind.Local).AddTicks(2630), "", "", "NIKE WEARALLDAY", 150m, null, 25, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "DateCreated", "Description", "Details", "Name", "Price", "ProductImage", "Stock", "Thumbnail" },
                values: new object[] { 3, 3, new DateTime(2021, 8, 26, 11, 58, 32, 128, DateTimeKind.Local).AddTicks(2771), "", "", "Puma Cali Star Metallic", 250m, null, 35, null });
