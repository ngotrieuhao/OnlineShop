...
namespace OnlineShop.Application.Catalog.Coupons
{
    public class CouponService : ICouponService
    {
        ...
        public CouponService(OnlineShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Update(CouponUpdateRequest request)
        {
            ...
            if (coupon == null) throw new OnlineShopException($"Can't find coupon with ID: {request.Id} ");
        ...
        public async Task<int> Delete(int couponId)
        {
            ...
            if (coupon == null) throw new OnlineShopException($"Can't find coupon with ID: {coupon} ");
