...
namespace OnlineShop.Application.Catalog.Categories
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<int> Update(CategoryUpdateRequest request)
        {
            ...
            if (category == null) throw new OnlineShopException($"Unable to find category with ID: {request.Id} ");
        ...
        public async Task<int> Delete(int categoryId)
        {
            ...
            if (category == null) throw new OnlineShopException($"Unable to find category with ID: {categoryId} ");
