...
namespace OnlineShop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(OnlineShopDbContext context, IStorageService storageService, IConfiguration configuration,
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null) throw new OnlineShopException($"Can't find product with ID: {request.Id} ");
        ...
        public async Task<int> Delete(int productId)
        {
            ...
            if (product == null) throw new OnlineShopException($"Can't find product with ID: {productId}");
        ...
        public async Task<bool> DecreaseStock(int productId, int quantity)
        {
            ...
            if (product == null) throw new OnlineShopException($"Cannot find product with id: {productId} ");
